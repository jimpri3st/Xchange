...
<body>
    ...
    ?>
        ...
        <div id="recentlyVisited" class="py-4 px-5 container"style="margin-top: 250px;">
            <div class="fixed-background">
                <div class="row">

                    <div class="col-12">
                        <h3 class="heading text-center pb-3" style= "font-size:44px; color: white;">Recently you visited</h3>
                    </div>
